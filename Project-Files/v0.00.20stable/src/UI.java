...
//↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ Difficulty Menu ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓//
    ...
    public void showInfo() {
        ...
        while(true){
            ...
            System.out.println("||- Use number keys to navigate menus.                                                      ||");
            System.out.println("||- Version                 : 0.00.20stable                                                 ||");
    ...
    public void printGun(){
        System.out.println("Current bullet: " + v.currentBullet);
        System.out.println("Current status: " + v.Rounds[v.currentRound][v.currentBullet]);
System.out.println("Player Turn: " + v.playerTurn);
        System.out.println("DEBUG - Bullet Array: " + Arrays.toString(v.Rounds[v.currentRound]));
System.out.println("DEBUG - Array Length: " + v.Rounds[v.currentRound].length);
System.out.println("DEBUG - Live: " + v.Live[v.currentRound] + ", Blank: " + v.Blank[v.currentRound]);
System.out.println("DEBUG - Health(Player): " + (v.playerHealth) + ", Health(Dealer): " + (v.botHealth));
    ...
    public void printDecision(){
        if(v.botShootsPlayer == null){
            System.out.println("  You start first.");
        }
        else if(v.botShootsPlayer){
    ...
    public void showPlayer() {
        while(true){
            ...
            if(v.playerHasItem){
                System.out.println("  Your Inventory: " + Arrays.toString(v.playerItems));
            }
            l.checkItems();
            if(v.playerHasItem){
                for(boolean i = true; i && (v.itemInput.matches("S|H|C|B|M") || v.itemInput.isEmpty());){
                    v.itemAccepted = l.processItem();
                    if(!v.itemAccepted || v.itemInput.isEmpty()){
                        i = false;
                    }
                }
            }
