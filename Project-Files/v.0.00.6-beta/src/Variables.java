public class Variables{ 
    ...
    public String[] botItems;
    public String[] drinkBeer = new String[] {};
    public String[] smokeCigarette = new String[] {};
    public String[] lockHandcuffs = new String[] {};
    public String[] breakMagnifier = new String[] {};
    public String[] cutBarrel = new String[] {};
